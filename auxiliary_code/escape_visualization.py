...
def visualize_escape(self, video_path, v):
    ...
    for trial, start_stim_end_frame in enumerate(self.start_stim_end_frames[v]):
        ...
        while True:
            ...
            # draw points corresponding to each body part
            if self.show_body_part_dots:
                visualization_video_frame_dots = visualization_video_frame.copy()
                for body_part in ['snout_location', 'neck_location', 'center_body_location', 'butt_location']:
